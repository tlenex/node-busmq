...
exports = module.exports = function(bus, name, object, attributes) {
  ...
  object._pconnection = function(cb) {
    var _this = this;
    ...
    this._p.connection = this._p.bus._connection(this._p.persistKey, function(connection) {
  ...
  object.ptouch = function() {
    var _this = this;
    this._pconnection(function(con) {
  ...
  object.pread = function(cb) {
    var _this = this;
    this._pconnection(function(con) {
      con.hgetall(_this._p.persistKey, function(err, resp) {
        cb && cb(err, resp);
      });
    });
  };
  ...
  object.save = function(cb) {
    ...
    this.pwrite(dirtyValues, function(err, resp) {
      if (err || resp !== 'OK') {
  ...
  object.pwrite = function(dirty, cb) {
    var _this = this;
    var fieldsvalues = [this._p.persistKey];
