...
WSMux.prototype._onMessage = function(message) {
  // first 16 bytes are always the id
  var packet = {
    id: message.slice(0, 16),
    type: message.charAt(16)
  };

  if (packet.type === '1') {
    packet.binary = message.charAt(17) === '1';
    packet.msg = message.slice(18);
